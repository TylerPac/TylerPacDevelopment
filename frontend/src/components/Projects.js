...
function Projects() {
  const projects = [
    ...
    },
    {
      ...
      description: "Interactive weather application with location-based forecasts, historical data visualization, and weather alerts. Features responsive design and offline capabilities.",
      languages: ["JavaScript", "CSS", "HTML"],
      tools: ["React", "Chart.js", "OpenWeather API", "PWA", "LocalStorage"],
      githubUrl: "https://github.com/TylerPac/weather-dashboard",
                  ...
                  <div className="tech-section">
                    ...
                    <div className="tech-tags">
                      {project.tools.map((tool, index) => (
                        <span key={index} className="tech-tag tool-tag">{tool}</span>
                      ))}
                    </div>
                  </div>
                </div>
