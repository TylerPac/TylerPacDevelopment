    ...
    <nav className="navbar">
      <div className="nav-container">
        ...
        <ul className="nav-menu">
          ...
          <li className="nav-item">
            <a href="https://github.com/TylerPac" target="_blank" rel="noopener noreferrer" className="nav-link">Github</a>
          </li>
        </ul>
        ...
        <div className={`mobile-menu ${isMenuOpen ? 'active' : ''}`}>
          ...
          <ul className="mobile-nav-list">
            ...
            <li className="mobile-nav-item">
              <a href="https://github.com/TylerPac" target="_blank" rel="noopener noreferrer" className="mobile-nav-link" onClick={closeMenu}>Github</a>
            </li>
          </ul>
        </div>
      </div>
